...
const StyledModal = ({
  ...
  return (
    <>
      ...
      ></div>
      <div className="text-blue-gray-500 fixed z-[1001] m-4 w-11/12 min-w-[300px] place-items-center  rounded-lg bg-white font-sans text-base font-light leading-relaxed antialiased shadow-2xl sm:w-3/5 lg:w-2/5 lg:max-w-md">
